...
function setGame(){ socket.emit("gameSet", document.getElementById("gameInput").value); }
function winner(side){ socket.emit("setWinner", side); }
function clearWinner(){ socket.emit("clearWinner"); }
